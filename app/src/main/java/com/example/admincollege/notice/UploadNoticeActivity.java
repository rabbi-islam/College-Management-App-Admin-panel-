...
public class UploadNoticeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        previewImageView = findViewById(R.id.uploadImagePreview);
...
//        databaseReference = databaseReference.child("Notice");
        ...
        databaseReference.child("Notice").child(uniqueKey).setValue(noticeData).addOnSuccessListener(new OnSuccessListener<Void>() {
            @Override
            public void onSuccess(Void unused) {
                pd.dismiss();
                Toast.makeText(UploadNoticeActivity.this, "Successfully Uploaded", Toast.LENGTH_SHORT).show();
            }
